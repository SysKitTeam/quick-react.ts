...
import { Pivot, PivotItem, Label, PivotLinkFormat } from '../../src';


const optionsLinks = {
    links: PivotLinkFormat.links,
    tabs: PivotLinkFormat.tabs,
    minimalTabs: PivotLinkFormat.minimalTabs,
    minimalTabsNoBorders: PivotLinkFormat.minimalTabsNoBorders
};
...
stories.add('Pivot showcase', () => (
    ...
    <Pivot 
        ...
        linkFormat={selectV2('link format', optionsLinks, PivotLinkFormat.links, 'Pivot knobs')}
        >
