...
/***/ function(module, exports, __webpack_require__) {
	...
	var Breadcrumbs_1 = __webpack_require__(491);
	var Index = function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(Breadcrumbs_1.Breadcrumbs, { items: [{ text: 'Files', 'key': 'Files' }, { text: 'This is folder 1', key: 'f1', href: '#1' }, { text: 'This is folder 2', key: 'f2', href: '#2' }, {
	                text: 'This is folder 3', key: 'f3', href: '#3', children: [{ text: 'This is folder 100', key: 'f100' }, { text: 'This is folder 200', key: 'f200' }]
	            }, { text: 'This is folder 4', key: 'f4', href: '#4' }, { text: 'This is folder 5', key: 'f5', onClick: function () {
	                    console.log('click');
	                } }], maxDisplayedItems: 3 }));
	    };
	    ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContextualMenu_1 = __webpack_require__(492);
	var getId_1 = __webpack_require__(494);
	var autobind_1 = __webpack_require__(498);
	var rtl_1 = __webpack_require__(495);
	...
	var Breadcrumbs = function (_super) {
	    ...
	    Breadcrumbs.prototype.render = function () {
	        ...
	        var _a = this.state,
	            isOverflowOpen = _a.isOverflowOpen,
	            overflowAnchor = _a.overflowAnchor,
	            renderedItems = _a.renderedItems,
	            renderedOverflowItems = _a.renderedOverflowItems;
	        var overflowMenuId = this._id + '-overflow';
	        return React.createElement("div", { className: 'breadcrumbs', ref: "renderingArea" }, React.createElement("ul", { className: 'breadcrumbs-list' }, renderedOverflowItems && renderedOverflowItems.length ? React.createElement("li", { className: 'breadcrumbs-overflow', key: OVERFLOW_KEY, ref: OVERFLOW_KEY }, React.createElement("div", { className: 'breadcrumb-overflowButton', onClick: this._onOverflowClicked, "data-is-focusable": true, role: "button" }, React.createElement(Icon_1.Icon, { iconName: 'icon-inProgress' })), React.createElement(Icon_1.Icon, { iconName: rtl_1.getRTL() ? 'icon-arrowDownRight' : 'icon-arrowRight' })) : null, renderedItems.map(function (item, index) {
	            return React.createElement("li", { className: 'breadcrumbs-list-item', key: item.key || String(index), ref: item.key || String(index) }, React.createElement("a", { className: 'breadcrumbs-item-link', onClick: item.onClick ? _this._onBreadcrumbClicked.bind(_this, item) : null, href: item.href, role: item.onClick ? 'button' : 'link' }, item.text), React.createElement(Icon_1.Icon, { iconName: rtl_1.getRTL() ? 'icon-arrowDownRight' : 'icon-arrowRight' }));
	        }), isOverflowOpen ? React.createElement(ContextualMenu_1.ContextualMenu, { target: overflowAnchor, isBeakVisible: true, items: renderedOverflowItems.map(function (item, index) {
	                return {
	                    name: item.text,
	                    key: item.key,
	    ...
	    __decorate([autobind_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', [Object]), __metadata('design:returntype', void 0)], Breadcrumbs.prototype, "_onOverflowClicked", null);
	    __decorate([autobind_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', [MouseEvent]), __metadata('design:returntype', void 0)], Breadcrumbs.prototype, "_onOverflowDismissed", null);
	    __decorate([autobind_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', [Object, Object]), __metadata('design:returntype', void 0)], Breadcrumbs.prototype, "_onBreadcrumbClicked", null);
	    return Breadcrumbs;
	}(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "::-webkit-scrollbar {\n  width: 13px;\n  margin-top: 10px;\n  border-radius: 15px;\n  margin-right: 3px;\n  background: transparent;\n}\n\n::-webkit-scrollbar-track {\n  border-radius: 15px;\n  margin-top: 7px;\n  background: #EEEFF4;\n  margin-bottom: 7px;\n}\n\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  margin-top: 10px;\n  background: #D2D3D9;\n}\n\n::-webkit-scrollbar-thumb:window-inactive {\n  background: #D2D3D9;\n}\n\n.breadcrumbs {\n  font-family: \"Segoe UI WestEuropean\",\"Segoe UI\",-apple-system,BlinkMacSystemFont,Roboto,\"Helvetica Neue\",sans-serif;\n  -webkit-font-smoothing: antialiased;\n  margin-top: 25px;\n}\n\n.breadcrumbs .breadcrumbs-list {\n  white-space: nowrap;\n  padding: 0;\n  margin: 0;\n}\n\n.breadcrumbs .breadcrumbs-list-item {\n  list-style-type: none;\n  vertical-align: top;\n  margin: 0;\n  padding: 0;\n  display: inline-block;\n  position: relative;\n  font-size: 14px;\n}\n\n.breadcrumbs .breadcrumbs-list-item:last-of-type .breadcrumbs-item-link {\n  color: #0078d7;\n}\n\n.breadcrumbs .breadcrumbs-list-item:last-of-type .icon {\n  display: none;\n}\n\n.breadcrumbs .breadcrumbs-item-link {\n  color: #333333;\n  display: inline-block;\n  padding: 0 4px;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  vertical-align: top;\n  cursor: pointer;\n  text-decoration: none;\n}\n\n.breadcrumbs .breadcrumbs-overflow {\n  display: inline-block;\n  position: relative;\n}\n\n.breadcrumbs .breadcrumb-overflowButton {\n  font-size: 16px;\n  display: inline-block;\n  cursor: pointer;\n  vertical-align: top;\n}\n", ""]);
...
//# sourceMappingURL=Breadcrumbs.e403d7b187b12e8ae34c.js.map