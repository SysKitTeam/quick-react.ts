...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBar_1 = __webpack_require__(1080);
	var MessageBar_Props_1 = __webpack_require__(1081);
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", null, React.createElement(MessageBar_1.MessageBar, { messageBarType: MessageBar_Props_1.MessageBarType.warning, hasDontShowAgain: true, dontShowAgainChecked: this.state.dontShowAgainChecked, dontShowAgainClicked: function () {
	                return _this.setState({ dontShowAgainChecked: !_this.state.dontShowAgainChecked });
	            }, onDismiss: function () {
	                console.log('test');
	            } }, "This is warning messageBar!"));
	    };
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBar = /** @class */function (_super) {
	    ...
	    function MessageBar(props) {
	        var _this = _super.call(this, props) || this;
	        _this.ICON_MAP = (_a = {}, _a[MessageBar_Props_1.MessageBarType.info] = 'icon-details', _a[MessageBar_Props_1.MessageBarType.warning] = 'icon-warning', _a[MessageBar_Props_1.MessageBarType.error] = 'icon-delete', _a[MessageBar_Props_1.MessageBarType.success] = 'icon-checkmark', _a);
	        _this.state = {
	    ...
	    MessageBar.prototype.render = function () {
	        var _a = this.props,
	            hasDontShowAgain = _a.hasDontShowAgain,
	            dontShowAgainChecked = _a.dontShowAgainChecked,
	            dontShowAgainClicked = _a.dontShowAgainClicked;
	        ...
	        return React.createElement("div", { className: messageBarClassName, role: "status" }, React.createElement("div", { className: 'messageBar-content' }, this._getIconSpan(), React.createElement("div", { className: 'messageBar-actionables' }, React.createElement("div", { className: 'messageBar-text', id: this.state.labelId }, React.createElement("span", { className: this._getInnerTextClassName(), title: tooltip }, this.props.children)), this._getActionsDiv(), this._getDontShowAgainDiv(), this._getDismissDiv())));
	    };
	    MessageBar.prototype._getIconSpan = function () {
	        return React.createElement("div", { className: 'messageBar-icon' }, React.createElement(Icon_1.Icon, { iconName: this.ICON_MAP[this.props.messageBarType] }));
	    };
	    ...
	    MessageBar.prototype._getActionsDiv = function () {
	        if (this.props.actions) {
	            return React.createElement("div", { className: 'messageBar-actionsOneline' }, this.props.actions);
	        }
	        return null;
	    };
	    MessageBar.prototype._getDismissDiv = function () {
	        if (this.props.onDismiss != null) {
	            return React.createElement(Icon_1.Icon, { disabled: false, className: 'messageBar-dismissal', onClick: this.props.onDismiss, iconName: 'icon-delete' });
	        }
	        return null;
	    };
	    MessageBar.prototype._getDontShowAgainDiv = function () {
	        ...
	        if (this.props.hasDontShowAgain != null && this.props.hasDontShowAgain) {
	            return React.createElement("div", { className: "messageBar-checkBox-container" }, React.createElement(Checkbox_1.Checkbox, { className: 'messageBar-checkbox', checked: this.props.dontShowAgainChecked, label: 'Don\'t show this message again', onChange: this.props.dontShowAgainClicked }));
	        }
	        return null;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./MessageBar.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./MessageBar.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.messageBar {\n  background-color: #ffffff;\n  border: 1px solid #DADADB;\n  border-left: 0;\n  border-radius: 0 8px 8px 0;\n  color: #ffffff;\n  box-sizing: border-box;\n  position: absolute;\n  user-select: none;\n  height: 32px;\n  width: 60%;\n  margin: 0 20%;\n  bottom: 10px;\n  z-index: 10;\n}\n\n.messageBar .messageBar-content {\n  padding-right: 10px;\n  display: flex;\n  align-items: center;\n  height: 100%;\n}\n\n.messageBar .messageBar-icon {\n  display: flex;\n  align-items: center;\n  margin-left: -16px;\n}\n\n.messageBar .messageBar-icon::before {\n  content: '';\n  width: 32px;\n  height: 32px;\n  box-sizing: border-box;\n  border-radius: 50%;\n}\n\n.messageBar .messageBar-icon .icon {\n  color: #ffffff;\n  position: absolute;\n  font-size: 16px;\n  margin-right: 0;\n  left: -8px;\n}\n\n.messageBar .messageBar-actionables {\n  display: flex;\n  flex-direction: row;\n  width: 100%;\n  margin-right: 20px;\n  min-width: 0;\n}\n\n.messageBar .messageBar-actionables .messageBar-text {\n  min-width: 0;\n  display: flex;\n  margin-left: 15px;\n}\n\n.messageBar .messageBar-actionables .messageBar-text .messageBar-innerText {\n  overflow-x: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  cursor: default;\n}\n\n.messageBar .messageBar-actionables .messageBar-actionsOneline {\n  position: absolute;\n  right: 40px;\n  top: -1px;\n}\n\n.messageBar .messageBar-actionables .messageBar-checkBox-container {\n  flex: 1;\n  min-width: 250px;\n}\n\n.messageBar .messageBar-actionables .messageBar-checkBox-container .messageBar-checkbox {\n  position: absolute;\n  right: 45px;\n  top: -1px;\n}\n\n.messageBar .messageBar-actionables .messageBar-checkBox-container .messageBar-checkbox .checkbox-label {\n  margin-top: 8px;\n}\n\n.messageBar .messageBar-actionables .messageBar-dismissal {\n  right: 5px;\n  position: absolute;\n  top: 8px;\n  cursor: pointer;\n}\n\n.messageBar .messageBar-actionables .messageBar-dismissal:hover {\n  color: #F79428;\n}\n\n.messageBar.messageBar-warning .messageBar-icon:before {\n  background-color: #EAC71A;\n}\n\n.messageBar.messageBar-error .messageBar-icon:before {\n  background-color: #FB6464;\n}\n\n.messageBar.messageBar-success .messageBar-icon:before {\n  background-color: #7DC458;\n}\n\n.messageBar.messageBar-info .messageBar-icon:before {\n  background-color: #4D4D4F;\n}\n\n.messageBar + .messageBar {\n  margin-top: 10px;\n}\n", ""]);
...
//# sourceMappingURL=MessageBar.b3d14060d786be20b6e9.js.map