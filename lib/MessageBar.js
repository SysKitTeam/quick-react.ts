...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBar_1 = __webpack_require__(668);
	var MessageBar_Props_1 = __webpack_require__(669);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBar = function (_super) {
	    ...
	    function MessageBar(props) {
	        _super.call(this, props);
	        this.ICON_MAP = (_a = {}, _a[MessageBar_Props_1.MessageBarType.info] = 'icon-details', _a[MessageBar_Props_1.MessageBarType.warning] = 'icon-warning', _a[MessageBar_Props_1.MessageBarType.error] = 'icon-error', _a[MessageBar_Props_1.MessageBarType.success] = 'icon-checkmark', _a);
	        this.state = {
	    ...
	    MessageBar.prototype.render = function () {
	        ...
	        return React.createElement("div", { className: messageBarClassName, role: "status" }, React.createElement("div", { className: 'messageBar-content' }, this._getIconSpan(), React.createElement("div", { className: 'messageBar-actionables' }, this._getDismissDiv(), this._getDontShowAgainDiv(), React.createElement("div", { className: 'messageBar-text', id: this.state.labelId }, React.createElement("span", { className: this._getInnerTextClassName() }, this.props.children))), this._getActionsDiv()));
	    };
	    ...
	    MessageBar.prototype._getActionsDiv = function () {
	        if (this.props.actions) {
	            return React.createElement("div", { className: 'messageBar-actionsOneline' }, this._getDismissDiv(), this.props.actions);
	        }
	        return null;
	    };
	    ...
	    MessageBar.prototype._getDontShowAgainDiv = function () {
	        ...
	        if (this.props.hasDontShowAgain != null && this.props.hasDontShowAgain) {
	            return React.createElement(Checkbox_1.Checkbox, { className: 'messageBar-checkbox', checked: this.props.dontShowAgainChecked, label: 'Dont show this message again', onChange: this.props.dontShowAgainClicked });
	        }
	        return null;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "::-webkit-scrollbar {\n  width: 13px;\n  margin-top: 10px;\n  border-radius: 15px;\n  margin-right: 3px;\n  background: transparent;\n}\n\n::-webkit-scrollbar-track {\n  border-radius: 15px;\n  margin-top: 7px;\n  background: #EEEFF4;\n  margin-bottom: 7px;\n}\n\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  margin-top: 10px;\n  background: #D2D3D9;\n}\n\n::-webkit-scrollbar-thumb:window-inactive {\n  background: #D2D3D9;\n}\n\n.messageBar {\n  font-family: \"Segoe UI WestEuropean\",\"Segoe UI\",-apple-system,BlinkMacSystemFont,Roboto,\"Helvetica Neue\",sans-serif;\n  -webkit-font-smoothing: antialiased;\n  background-color: #f4f4f4;\n  color: #333333;\n  width: 100%;\n  box-sizing: border-box;\n  display: flex;\n  position: relative;\n}\n\n.messageBar .messageBar-icon {\n  padding-right: 8px;\n  color: #767676;\n}\n\n.messageBar .link {\n  font-size: 12px;\n}\n\n.messageBar-icon,\n.messageBar-text {\n  display: table-cell;\n  vertical-align: top;\n}\n\n.messageBar-icon {\n  font-size: 14px;\n  min-width: 16px;\n  min-height: 16px;\n  display: flex;\n}\n\n.messageBar-text {\n  font-family: \"Segoe UI WestEuropean\",\"Segoe UI\",-apple-system,BlinkMacSystemFont,Roboto,\"Helvetica Neue\",sans-serif;\n  -webkit-font-smoothing: antialiased;\n  font-size: 12px;\n  font-weight: 400;\n  min-width: 0;\n  display: flex;\n}\n\n.messageBar.messageBar-info {\n  background-color: #a3cfff;\n  color: #333333;\n}\n\n.messageBar.messageBar-info .messageBar-icon > i {\n  color: #0078d7;\n}\n\n.messageBar.messageBar-warning {\n  background-color: #fff4ce;\n  color: #333333;\n}\n\n.messageBar.messageBar-warning .messageBar-icon > i {\n  color: #ffb900;\n}\n\n.messageBar.messageBar-error {\n  background-color: #fde7e9;\n  color: #333333;\n}\n\n.messageBar.messageBar-error .messageBar-icon > i {\n  color: #a80000;\n}\n\n.messageBar.messageBar-success {\n  background-color: #dff6dd;\n  color: #333333;\n}\n\n.messageBar.messageBar-success .messageBar-icon > i {\n  color: #107c10;\n}\n\n.messageBar-content {\n  padding: 10px;\n  display: flex;\n  width: 100%;\n  box-sizing: border-box;\n}\n\n.messageBar-actionables {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  min-width: 0;\n}\n\n.messageBar-actionables > .messageBar-dismissal {\n  right: 0;\n  position: absolute !important;\n}\n\n.messageBar-actions, .messageBar-actionsOneline {\n  display: flex;\n  flex: 0 0 auto;\n  flex-direction: row-reverse;\n  align-items: center;\n}\n\n.messageBar-actionsOneline {\n  position: relative;\n}\n\n.messageBar-dismissal {\n  min-width: 0;\n  cursor: pointer;\n}\n\n.messageBar-actionsOneline .messageBar-dismissal {\n  margin-right: -8px;\n}\n\n.messageBar-checkbox {\n  right: 45px;\n  top: 0;\n  position: absolute !important;\n}\n\n.messageBar + .messageBar {\n  margin-bottom: 6px;\n}\n\n.messageBar-innerTextPadding {\n  padding-right: 24px;\n}\n\n.messageBar-innerTextPadding span, .messageBar-innerTextPadding .messageBar-innerText > span {\n  padding-right: 4px;\n}\n\n.messageBar-singleline .messageBar-content .messageBar-icon {\n  align-items: center;\n}\n\n.messageBar-singleline .messageBar-content .messageBar-actionables > .messageBar-text {\n  justify-content: center;\n  align-items: center;\n}\n\n.messageBar-singleline .messageBar-content .messageBar-actionables > .messageBar-text .messageBar-innerText,\n.messageBar-singleline .messageBar-content .messageBar-actionables > .messageBar-text .messageBar-innerTextPadding {\n  max-height: 1.3em;\n  line-height: 1.3em;\n  overflow-x: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n\n.messageBar-singleline .messageBar-content > .messageBar-actionables {\n  flex-direction: row;\n}\n", ""]);
...
//# sourceMappingURL=MessageBar.5af099dfabf0e722b9fa.js.map