...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagContainer_1 = __webpack_require__(538);
	...
	var Index = function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(TagContainer_1.TagContainer, { title: 'Roles', tags: [{ display: 'Tag1', iconName: 'icon-Add' }, { display: 'Tag2', iconName: 'icon-Alert' }, { display: 'Tag3', iconName: 'icon-Buy' }] }, React.createElement("div", { className: "edit-tags tag", title: "Edit tags" }, React.createElement(Icon_1.Icon, { className: "icon-Edit" }))));
	    };
	    ;
	    return Index;
	}(React.Component);
...
//# sourceMappingURL=TagContainer.6b09275fc1b677367a78.js.map