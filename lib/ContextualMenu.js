...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContextualMenu_1 = __webpack_require__(596);
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(ContextualMenu_1.ContextualMenu, { shouldFocusOnMount: true, targetPoint: { x: 1000, y: 300 }, useTargetPoint: true, onDismiss: function () {}, directionalHint: DirectionalHint_1.DirectionalHint.bottomRightEdge, items: [{
	                key: 'newItem',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContextualMenu = /** @class */function (_super) {
	    ...
	    ContextualMenu.prototype.render = function () {
	        ...
	        return React.createElement(Callout_1.Callout, { target: target, targetPoint: targetPoint, useTargetPoint: useTargetPoint, isBeakVisible: isBeakVisible, beakWidth: beakWidth, directionalHint: directionalHint, gapSpace: gapSpace, coverTarget: coverTarget, doNotLayer: doNotLayer, className: classNames('contextualMenu-Callout', { 'is-expanded': !(expandedMenuItemKey === null || expandedMenuItemKey === undefined) }), setInitialFocus: true, onDismiss: this.props.onDismiss }, React.createElement("div", { ref: function (host) {
	    ...
	    ContextualMenu.prototype._renderAnchorMenuItem = function (item, index, hasCheckmarks, hasIcons) {
	        return React.createElement("div", null, React.createElement("a", __assign({}, attributes_1.getNativeAttributes(item, attributes_1.anchorAttributes), { href: item.href, className: classNames('contextualMenu-link contextualMenu-anchor-link', item.disabled ? 'is-disabled' : ''), role: "menuitem", target: "_blank", onClick: this._onAnchorClick.bind(this, item) }), hasIcons ? this._renderIcon(item) : null, React.createElement("span", { className: 'contextualMenu-linkText' }, " ", item.name, " ")));
	    };
	    ContextualMenu.prototype._renderIcon = function (item) {
	        var iconProps = item.iconProps;
	        var iconColorClassName = iconProps !== undefined && iconProps.iconName === '' ? '' : 'contextualMenu-iconColor';
	        var iconClassName = classNames('contextualMenu-icon', iconColorClassName, iconProps !== undefined && iconProps.className !== undefined ? iconProps.className : '');
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.contextualMenu-container .contextualMenu {\n  min-width: 180px;\n  max-width: 250px;\n  box-sizing: border-box;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list {\n  margin: 4px 0;\n  padding: 0;\n  line-height: 0;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item {\n  height: 28px;\n  position: relative;\n  box-sizing: border-box;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link {\n  outline: none;\n  position: relative;\n  background: none;\n  border: none;\n  width: 100%;\n  height: 28px;\n  line-height: 28px;\n  cursor: pointer;\n  padding: 0px 6px;\n  text-align: left;\n  text-decoration: none;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link:hover:not([disabled]) {\n  background: #FDEAD4;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.is-disabled .contextualMenu-linkContent span, .contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.is-disabled .contextualMenu-linkContent .contextualMenu-submenu-chevron, .contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link[disabled] .contextualMenu-linkContent span, .contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link[disabled] .contextualMenu-linkContent .contextualMenu-submenu-chevron {\n  color: #AEAEAF;\n  cursor: default;\n  pointer-events: none;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.is-disabled .contextualMenu-icon, .contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link[disabled] .contextualMenu-icon {\n  color: #AEAEAF;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.is-expanded .contextualMenu-submenu-chevron, .contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.is-expanded:hover .contextualMenu-submenu-chevron {\n  color: #F79428;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link .contextualMenu-linkContent {\n  white-space: nowrap;\n  display: flex;\n  align-items: center;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link .contextualMenu-linkContent .contextualMenu-itemText {\n  margin: 0 4px;\n  vertical-align: middle;\n  display: inline-block;\n  flex-grow: 1;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  white-space: nowrap;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link .contextualMenu-icon {\n  margin: 0 4px;\n  vertical-align: middle;\n  flex-shrink: 0;\n  width: 14px;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link .contextualMenu-linkText {\n  margin: 0 4px;\n  vertical-align: middle;\n  flex-grow: 1;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  white-space: nowrap;\n  width: calc(100% - 20px);\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link .contextualMenu-submenu-chevron {\n  height: 28px;\n  line-height: 28px;\n  text-align: center;\n  font-size: 12px;\n  display: inline-block;\n  vertical-align: middle;\n  flex-shrink: 0;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.contextualMenu-anchor-link:hover {\n  background-color: #ffffff;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-item .contextualMenu-link.contextualMenu-anchor-link:hover .contextualMenu-linkText {\n  color: #F79428;\n  text-decoration: underline;\n}\n\n.contextualMenu-container .contextualMenu .contextualMenu-list .contextualMenu-divider {\n  display: block;\n  height: 1px;\n  background-color: #DADADB;\n  position: relative;\n  margin: 4px 0;\n}\n\n.contextualMenu-Callout.is-expanded {\n  border-color: #DADADB;\n}\n", ""]);
...
//# sourceMappingURL=ContextualMenu.b3d14060d786be20b6e9.js.map