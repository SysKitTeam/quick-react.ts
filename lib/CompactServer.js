...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", { style: { width: '220px' } }, React.createElement(CompactServer_1.CompactServer, { id: 'CUSTOM-PC.localdomain', onClose: this._onServerCloseCompactServer, onRoleEdit: this._onRoleEdit, name: 'CUSTOM-PC', roles: [], status: 1 }), React.createElement(CompactServer_1.CompactServer, { id: 'My very very long name of a server I am using I know its very long.domain.com', onRoleEdit: this._onRoleEdit, name: 'My very very long name of a server I am using I know its very long', roles: [], status: 2 }), React.createElement(CompactServer_1.CompactServer, { id: 'BANANA-PC.banana.com', onRoleEdit: this._onRoleEdit, name: 'BANANA-PC', roles: [{ display: 'WPF', iconName: 'icon-add' }, { display: 'Search', iconName: 'icon-alert' }], status: 0 }), React.createElement(CompactServer_1.CompactServer, { id: 'BANANA-PC.banana.com', onRoleEdit: this._onRoleEdit, onClose: this._onServerCloseCompactServer, name: 'BANANA-PC', roles: [{ display: 'WPF', iconName: 'icon-add' }, { display: 'Search', iconName: 'icon-alert' }, { display: 'App', iconName: 'icon-add' }, { display: 'Tag', iconName: 'icon-add' }], status: 3 }));
	    };
	    Index.prototype._onRoleEdit = function (serverId) {
...
//# sourceMappingURL=CompactServer.b3d14060d786be20b6e9.js.map