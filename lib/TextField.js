...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", { style: { width: '300px' } }, React.createElement(TextField_1.TextField, { label: "TextField with a placeholder:", placeholder: "Now I am a Placeholder" }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Required TextField:", required: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Disabled TextField:", disabled: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Error TextField:", errorMessage: 'This is error message! This is error message!' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Description TextField:", description: 'Description Message' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: 'Underlined TextField:', placeholder: "Underlined TextField", underlined: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Multiline TextField:", multiline: true, rows: 4, cols: 50 }));
	    };
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
//# sourceMappingURL=TextField.b3d14060d786be20b6e9.js.map