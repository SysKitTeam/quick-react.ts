...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(ServerTile_1.ServerTile, { id: 'server-123', status: 0, name: 'SP2016-Martin', onClose: function (id) {
	                ...
	                usageUnit: 'GB',
	                id: 2
	            }], roles: [], countersData: [{ title: 'CPU', currentUsage: '43', usageUnit: '%', hoverText: [''], status: models_1.ServerStatus.OK }, { title: 'Memory', currentUsage: '7', usageUnit: 'GB', hoverText: ['7GB/10GB (70%)'], status: models_1.ServerStatus.Warning }, { title: 'Disk', currentUsage: '0,1', usageUnit: 'Mbps', hoverText: ['4.49 Mbps', '2.63 Mbps', '0.3 Mbps'], status: models_1.ServerStatus.OK }, { title: 'Network', currentUsage: '0,1', usageUnit: 'MB/s', hoverText: ['50.10 kB/s', '23.47 kB/s'], status: models_1.ServerStatus.Critical }] }), React.createElement(ServerTile_1.ServerTile, { id: 'server-123', status: 0, name: 'SP2016-Martin', numberOfUsers: '10', onClose: function (id) {
	                return console.log('Go away!', id);
	            }, diskInformation: [{
	                name: 'Local Disk (C:)',
	                used: 800,
	                ...
	                usageUnit: 'GB',
	                id: 2
	            }], roles: [{ display: 'WPF', iconName: 'icon-add', tooltip: 'WPF Role' }, { display: 'Search', iconName: 'icon-alert' }], countersData: [{ title: 'CPU', currentUsage: '43', usageUnit: '%', hoverText: [''], status: models_1.ServerStatus.OK }, { title: 'Memory', currentUsage: '7', usageUnit: 'GB', hoverText: ['7GB/10GB (70%)'], status: models_1.ServerStatus.Warning }, { title: 'Disk', currentUsage: '0,1', usageUnit: 'Mbps', hoverText: ['4.49 Mbps', '2.63 Mbps', '0.3 Mbps'], status: models_1.ServerStatus.OK }, { title: 'Network', currentUsage: '0,1', usageUnit: 'MB/s', hoverText: ['50.10 kB/s', '23.47 kB/s'], status: models_1.ServerStatus.Critical }] }));
	    };
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
//# sourceMappingURL=ServerTile.b3d14060d786be20b6e9.js.map