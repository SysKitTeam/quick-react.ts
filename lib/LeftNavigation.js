...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeftNavigation_1 = __webpack_require__(647);
	...
	var LeftNavigation = function (_super) {
	    ...
	    LeftNavigation.prototype.render = function () {
	        ...
	        var children = this.props.options.map(function (option, index) {
	            ...
	            return React.createElement("div", { key: option.id, className: linkClasses, title: option.text }, React.createElement("a", { id: option.id, onClick: function (ev) {
	                    return _this.onLinkClick(index, option, ev);
	                } }, React.createElement(Icon_1.Icon, { iconName: option.icon }), React.createElement("span", null, option.text)));
	        });
	        return React.createElement(tag, object_1.assign({}, { className: className }), React.createElement("div", null, React.createElement("div", { className: "nav-item", onClick: function () {
	                _this.onLeftNavigationClick();
	            } }, React.createElement(Icon_1.Icon, { iconName: 'icon-switchView' })), children));
	    };
	    ;
...
//# sourceMappingURL=LeftNavigation.e403d7b187b12e8ae34c.js.map