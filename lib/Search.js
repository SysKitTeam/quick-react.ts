...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search_1 = __webpack_require__(603);
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", { style: { width: '500px' } }, React.createElement(Search_1.Search, { onChange: function (newValue) {
	                return console.log('SearchBox onChange fired: ' + newValue);
	            }, onSearch: function (newValue) {
	                return console.log('SearchBox onSearch fired: ' + newValue);
	            } }), React.createElement(Search_1.Search, { disabled: true, onChange: function (newValue) {
	                return console.log('SearchBox onChange fired: ' + newValue);
	            }, onSearch: function (newValue) {
	                return console.log('SearchBox onSearch fired: ' + newValue);
	            } }), React.createElement(Search_1.Search, { onChange: function (newValue) {
	                return console.log('SearchBox onChange fired: ' + newValue);
	            }, onSearch: function (newValue) {
	                return console.log('SearchBox onSearch fired: ' + newValue);
	            }, underlined: true }), React.createElement(Search_1.Search, { disabled: true, onChange: function (newValue) {
	                return console.log('SearchBox onChange fired: ' + newValue);
	            }, onSearch: function (newValue) {
	                return console.log('SearchBox onSearch fired: ' + newValue);
	            }, underlined: true }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDocument_2 = __webpack_require__(529);
	...
	var Search = /** @class */function (_super) {
	    ...
	    function Search(props) {
	        ...
	        _this._callOnChange = _.debounce(_this._callOnChange, props.debounceWaitMs);
	        _this.state = {
	            value: props.value || '',
	            hasFocus: false,
	    ...
	    Search.prototype._removeFocus = function (ev) {
	        var target = ev.target;
	        if (ev.target !== this._targetWindow && (!this._inputElement || !elementContains_1.elementContains(this._inputElement, target, false))) {
	            this.setState({
	                hasFocus: false
	            });
	        }
	    ...
	    Search.prototype._setTargetWindowAndElement = function (target) {
	        if (target) {
	            var targetElement = target;
	            this._targetWindow = getDocument_2.getWindow(targetElement);
	        } else {
	            this._targetWindow = getDocument_2.getWindow();
	        }
	    };
	    Search.prototype.render = function () {
	        ...
	        return React.createElement("div", __assign({ ref: this._resolveRef('_rootElement'), className: searchClassName }, { onFocusCapture: this._onFocusCapture }), !underlined && React.createElement(Icon_1.Icon, { className: 'search-icon', iconName: 'icon-search' }), React.createElement("input", { id: id, className: 'search-field', value: value, placeholder: labelText, onChange: this._onInputChange, onKeyDown: this._onKeyDown, disabled: disabled, ref: this._resolveRef('_inputElement') }), underlined && React.createElement("div", { className: "search-button" }, React.createElement(Button_1.Button, { disabled: disabled, className: 'button-primary', icon: 'icon-search' })), React.createElement("div", { className: 'search-clearButton', onClick: this._onClearClick }, React.createElement(Icon_1.Icon, { iconName: 'icon-delete' })));
	    };
	    ...
	    Search.prototype._callOnChange = function (newValue) {
	        ...
	        var onChange = this.props.onChanged ? this.props.onChanged : this.props.onChange;
	        if (onChange) {
	            onChange(newValue);
	        }
	    };
	    ...
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Event]), __metadata("design:returntype", void 0)], Search.prototype, "_removeFocus", null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.search {\n  box-sizing: border-box;\n  position: relative;\n  margin-bottom: 10px;\n  border: 1px solid #DADADB;\n  border-radius: 8px;\n}\n\n.search:hover {\n  border-color: #B7B7B8;\n}\n\n.search .search-field {\n  box-sizing: border-box;\n  border: none;\n  outline: transparent 1px solid;\n  height: 30px;\n  line-height: 30px;\n  padding: 6px 38px 7px 33px;\n  width: 100%;\n  background-color: transparent;\n  transition: padding-left 167ms;\n  border-radius: 8px;\n}\n\n.search .search-field:focus {\n  padding-right: 32px;\n}\n\n.search .search-icon {\n  position: absolute;\n  left: 10px;\n  top: 0;\n  height: 30px;\n  line-height: 30px;\n  font-size: 16px;\n}\n\n.search.can-clear .search-clearButton {\n  display: block;\n}\n\n.search.is-active {\n  border-color: #F79428;\n}\n\n.search.is-active .search-field {\n  padding-left: 10px;\n}\n\n.search.is-active .search-icon {\n  display: none;\n}\n\n.search.is-disabled {\n  border-color: #DADADB;\n  user-select: none;\n}\n\n.search.is-disabled .search-icon {\n  color: #AEAEAF;\n}\n\n.search.is-disabled .search-field {\n  background-color: #F3F3F4;\n  pointer-events: none;\n  cursor: default;\n}\n\n.search.is-underlined {\n  border: 0;\n  border-bottom: 1px solid #DADADB;\n  border-radius: 0;\n}\n\n.search.is-underlined:hover {\n  border-color: #B7B7B8;\n}\n\n.search.is-underlined.is-active {\n  border-color: #F79428;\n}\n\n.search.is-underlined .search-field {\n  padding-left: 10px;\n}\n\n.search.is-underlined .search-button {\n  position: absolute;\n  right: 0;\n  top: -2px;\n}\n\n.search.is-underlined .search-clearButton {\n  right: 35px;\n}\n\n.search.is-underlined.is-disabled {\n  border-color: #DADADB;\n}\n\n.search.is-underlined.is-disabled .search-field {\n  background-color: #ffffff;\n}\n\n.search .search-clearButton {\n  display: none;\n  cursor: pointer;\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 30px;\n  height: 30px;\n  line-height: 30px;\n  text-align: center;\n}\n\n.search .search-clearButton .icon:hover {\n  color: #F79428;\n}\n", ""]);
...
//# sourceMappingURL=Search.b3d14060d786be20b6e9.js.map