...
/***/ function(module, exports, __webpack_require__) {
	...
	var PieChart_1 = __webpack_require__(672);
	var pieData_1 = __webpack_require__(676);
	var Index = function (_super) {
	    ...
	    Index.prototype.render = function () {
	        ...
	        return React.createElement("div", null, React.createElement("div", { style: divStyle }, React.createElement(Label_1.Label, { style: labelStyle }, "Pie chart component"), React.createElement(PieChart_1.PieChart, { id: 'chart-1', dimensions: { width: '100%', height: 'calc(100% - 40px)' }, data: pieData_1.pieUpdatedData, colors: ['#344086', '#8bd764', '#f3f986', '#ec1271', '#636363', 'red', 'green', 'purple', 'aquamarine', 'lightgrey'], tipText: function (d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = __webpack_require__(476);
	var PieChartContent_1 = __webpack_require__(673);
	...
	var PieChart = function (_super) {
	    ...
	    PieChart.prototype.render = function () {
	        var _this = this;
	        var pieComponentClass = classNames('pie-chart-component', this.props.id);
	    ...
	    PieChart.prototype.renderLegend = function (data) {
	        var legendClass = classNames('pie-chart-legend', this.props.id);
	        var color = this.createColorPallette();
	        var legend = data.map(function (d, index) {
	            return React.createElement("div", { key: index, className: 'legend-item' }, React.createElement("div", { style: { backgroundColor: color(d.label) } }), React.createElement("label", { style: { display: 'inline-block' } }, d.label));
	        });
	    ...
	    PieChart.prototype.transformData = function () {
	        ...
	        if (this.props.displayingElements !== undefined && this.props.displayingElements < sortedData.length) {
	            ...
	            var value = 0;
	            for (var i = elementsToTake; i < sortedData.length; i++) {
	    ...
	    PieChart.prototype.setDimensions = function (width, height) {
	        ...
	        if (!this.props.showLegend) {
	            ...
	            if (width - 10 < this.legendWidth) {
	                chartWidth = width;
	            } else {
	                chartWidth = width - this.legendWidth - 10;
	            }
	        }
	        if (chartWidth >= height) {
	            chartWidth = height;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PieChartContent = function (_super) {
	    ...
	    function PieChartContent(props) {
	        ...
	        this.createArc = function () {
	            return d3.arc().outerRadius(0).innerRadius(_this.props.width / 2);
	        };
	        /**
	         * Create pie generator for given data arguments.
	         */
	        this.createPie = function () {
	            return d3.pie().padAngle(.02).sort(null).value(function (d) {
	                return d.value;
	            });
	        };
	        /**
	    ...
	    PieChartContent.prototype.render = function () {
	        ...
	        return React.createElement("svg", { width: this.props.width, height: this.props.height }, React.createElement("g", { className: containerClass, transform: translate }, this.renderPaths(), React.createElement(Tooltip_1.Tooltip, { id: 'pie-chart-tooltip', x: this.state.tipX, y: this.state.tipY, text: this.state.tipText, visible: this.state.isTipVisible })));
	    };
	    /**
	    ...
	    PieChartContent.prototype.renderPaths = function () {
	        ...
	        return arcData.map(function (d, index) {
	            return React.createElement("path", { className: pieArcClass, key: index, d: arc({ startAngle: d.startAngle, endAngle: d.endAngle }), style: { fill: color(d.data.label) }, onMouseOver: function (event) {
...
//# sourceMappingURL=PieChart.5af099dfabf0e722b9fa.js.map