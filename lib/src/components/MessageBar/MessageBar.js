...
var MessageBar = (function (_super) {
    ...
    function MessageBar(props) {
        ...
        this.ICON_MAP = (_a = {},
            _a[MessageBar_Props_1.MessageBarType.info] = 'icon-Details',
            _a[MessageBar_Props_1.MessageBarType.warning] = 'icon-Warning',
            _a[MessageBar_Props_1.MessageBarType.error] = 'icon-.Error',
            _a[MessageBar_Props_1.MessageBarType.success] = 'icon-Checkmark',
            _a
        );
        this.state = {
