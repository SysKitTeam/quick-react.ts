...
var ContextualMenu = (function (_super) {
    ...
    ContextualMenu.prototype._renderMenuItemChildren = function (item, index, hasCheckmarks, hasIcons) {
        ...
        return (React.createElement("div", {className: "contextualMenu-linkContent"}, 
            (hasCheckmarks) ? (React.createElement(Icon_1.Icon, {iconName: isItemChecked ? 'icon-Checkmark' : '', className: 'contextualMenu-icon', onClick: this._onItemClick.bind(this, item)})) : (null), 
            (hasIcons) ? (this._renderIcon(item)) : (null), 
            React.createElement("span", {className: 'contextualMenu-itemText'}, item.name), 
            (item.items && item.items.length) ? (React.createElement(Icon_1.Icon, {className: 'contextualMenu-submenu-chevron', iconName: rtl_1.getRTL() ? 'icon-ArrowLeftSlim' : 'icon-ArrowRightSlim'})) : (null)));
    };
