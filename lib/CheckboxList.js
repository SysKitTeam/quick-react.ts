...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckboxList_1 = __webpack_require__(563);
	var Index = /** @class */function (_super) {
	    __extends(Index, _super);
	    function Index() {
	        var _this = _super.call(this) || this;
	        _this.state = {
	            checkboxElements: [{ id: 'A', text: 'Option A', checked: true }, { id: 'B', text: 'Option B' }, { id: 'C', text: 'Option C' }, { id: 'E', text: 'Option E' }, { id: 'G', text: 'Option G' }]
	        };
	        return _this;
	    }
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(CheckboxList_1.CheckboxList, { onCheckboxChanged: this._onCheckboxListChange, items: [{ id: 'A', text: 'Option A', isOpen: false, children: [{ text: 'Option B', checked: false, id: 'B1' }, { text: 'Option B', id: 'B2' }, { text: 'Option B', id: 'B3' }] }, { id: 'C', text: 'Option C', isOpen: false, children: [{ text: 'Option D', id: 'D1' }, { text: 'Option D', id: 'D2' }, { text: 'Option D', id: 'D3' }] }, { id: 'E', text: 'Option E', isOpen: false, children: [{ text: 'Option F', id: 'F1' }, { text: 'Option F', id: 'F2' }, { text: 'Option F', id: 'F3' }] }, { id: 'G', text: 'Option G', isOpen: false, children: [{ text: 'Option H', id: 'H1' }, { text: 'Option H', id: 'H2' }, { text: 'Option H', id: 'H3' }] }] }), React.createElement("br", null), React.createElement("br", null), React.createElement(CheckboxList_1.CheckboxList, { title: 'Checkbox List', onCheckboxChanged: this._onCheckboxListChange, items: this.state.checkboxElements }));
	    };
	    Index.prototype._onCheckboxListChange = function (ev, itemId, checked) {
	        this.setState({
	            checkboxElements: this.state.checkboxElements.map(function (item) {
	    ...
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, Object]), __metadata("design:returntype", void 0)], Index.prototype, "_onCheckboxListChange", null);
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(328);
	var classNames = __webpack_require__(497);
	var CheckboxListItem_1 = __webpack_require__(564);
	var Common_1 = __webpack_require__(536);
	...
	var CheckboxList = /** @class */function (_super) {
	    ...
	    CheckboxList.prototype.shouldComponentUpdate = function (nextProps, nextState) {
	        return !(this.props.items === nextProps.items && this.props.className === nextProps.className && this.props.title === nextProps.title);
	    };
	    CheckboxList.prototype.render = function () {
	        var _a = this.props,
	            title = _a.title,
	            items = _a.items,
	            onCheckboxChanged = _a.onCheckboxChanged;
	        var className = classNames('checkboxlist', [this.props.className]);
	        return React.createElement("div", { className: className }, title && React.createElement("div", { className: "label checkbox-list-label" }, title), items.map(function (item, index) {
	            return React.createElement(CheckboxListItem_1.CheckboxListItem, { key: index, item: item, onChange: onCheckboxChanged });
	        }));
	    };
	    return CheckboxList;
	}(Common_1.CommonComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var autobind_1 = __webpack_require__(546);
	__webpack_require__(565);
	var CheckboxListItem = /** @class */function (_super) {
	    __extends(CheckboxListItem, _super);
	    function CheckboxListItem(props) {
	        var _this = _super.call(this, props) || this;
	        _this.state = { isOpen: props.isOpen, iconArrow: 'icon-arrow_right' };
	        return _this;
	    }
	    CheckboxListItem.prototype.shouldComponentUpdate = function (nextProps, nextState) {
	        return !(this.props.item === nextProps.item
	        // && this.props.onChange === nextProps.onChange
	        && this.state.isOpen === nextState.isOpen && this.state.iconArrow === nextState.iconArrow);
	    };
	    CheckboxListItem.prototype.render = function () {
	        var _a = this.props,
	            item = _a.item,
	            onChange = _a.onChange;
	        var isOpen = this.state.isOpen;
	        var itemClassName = classNames('checkboxlist-child', {
	            'expanded': this.state.isOpen,
	            'collapsed': !this.state.isOpen
	        });
	        var isParent = item.children && item.children.length > 0;
	        return React.createElement("div", null, isParent && React.createElement("div", { className: 'checkboxlist-item', onClick: this._onItemClick.bind(this) }, React.createElement(Icon_1.Icon, { iconName: this.state.iconArrow }), item.text), !isParent && React.createElement(Checkbox_1.Checkbox, { checked: item.checked !== undefined ? item.checked : false, label: item.text, onChange: onChange, itemId: item.id }), React.createElement("div", { className: itemClassName }, item.children && item.children.map(function (child, index) {
	            return React.createElement("div", { key: index }, React.createElement(Checkbox_1.Checkbox, { checked: child.checked !== undefined ? child.checked : false, label: child.text, onChange: onChange, itemId: child.id }));
	        })));
	    };
	    CheckboxListItem.prototype._onItemClick = function (ev) {
	        var isOpen = this.state.isOpen;
	        this.setState({
	            isOpen: !isOpen,
	    ...
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [MouseEvent]), __metadata("design:returntype", void 0)], CheckboxListItem.prototype, "_onItemClick", null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./CheckboxList.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./CheckboxList.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.checkboxlist .checkbox-list-label {\n  font-size: 16px;\n  color: #F79428;\n  height: 28px;\n  align-items: center;\n  display: flex;\n}\n\n.checkboxlist .checkboxlist-item {\n  cursor: pointer;\n}\n\n.checkboxlist .checkboxlist-item .icon {\n  font-size: 12px;\n}\n\n.checkboxlist .checkboxlist-child {\n  margin-left: 15px;\n}\n\n.checkboxlist .checkboxlist-child.collapsed {\n  display: none;\n}\n\n.checkboxlist .checkboxlist-child.expanded {\n  display: block;\n}\n", ""]);
...
//# sourceMappingURL=CheckboxList.b3d14060d786be20b6e9.js.map