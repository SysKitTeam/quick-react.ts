...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBox_1 = __webpack_require__(1084);
	...
	var mediumText = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec pulvinar, enim sit amet laoreet euismod, elit metus porta lectus, sed ultrices nibh ligula id tortor.';
	var shortText = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam molestie laoreet ligula.';
	var shortestText = 'Lorem ipsum dolor sit amet.';
	var Index = /** @class */function (_super) {
	    ...
	    function Index(props) {
	        ...
	        setTimeout(function () {
	            _this.setState({ isLoading: false, errorMessage: mediumText });
	        }, 6000);
	        return _this;
	    }
	    Index.prototype._changeState = function (isOpen) {
	        this.setState({ isOpen: isOpen });
	    };
	    Index.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", null, React.createElement(Button_1.Button, { onClick: function () {
	                return _this._changeState(true);
	            } }, "Open MessageBox"), React.createElement(MessageBox_1.MessageBox, { title: "Message box!", message: longText, onDismiss: function () {
	                return _this._changeState(false);
	            }, isOpen: this.state.isOpen, buttons: ['Button1'], onAccept: function () {
	                return console.log('Accept');
	            }, onClose: function () {
	                return console.log('On close');
	            }, isLoading: this.state.isLoading, errorMessage: this.state.errorMessage }));
	    };
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], Index.prototype, "_changeState", null);
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button_1 = __webpack_require__(557);
	var Icon_1 = __webpack_require__(518);
	var Spinner_1 = __webpack_require__(1085);
	var MessageBox_Props_1 = __webpack_require__(1089);
	var DirectionalHint_1 = __webpack_require__(523);
	...
	var MessageBox = /** @class */function (_super) {
	    ...
	    MessageBox.prototype.render = function () {
	        var _a = this.props,
	            ...
	            title = _a.title,
	            buttons = _a.buttons,
	            onCustomButtonClick = _a.onCustomButtonClick,
	            onClose = _a.onClose,
	            onAccept = _a.onAccept,
	            closeText = _a.closeText,
	            acceptText = _a.acceptText,
	            level = _a.level,
	            onDismiss = _a.onDismiss,
	        ...
	        var mappedButtons = buttons && buttons.map(function (button, index) {
	            var buttonText = '';
	            var isPrimary = false;
	            if (typeof button === 'string') {
	                ...
	                buttonText = customButton.title, isPrimary = customButton.primary;
	            }
	            return React.createElement(Button_1.Button, { className: isPrimary ? 'button-primary' : 'button-primary-gray', onClick: function () {
	                    return onCustomButtonClick(index);
	                } }, buttonText);
	        });
	        var iconName;
	        switch (level) {
	            case MessageBox_Props_1.MessageLevel.Information:
	                iconName = 'icon-details';
	                break;
	            case MessageBox_Props_1.MessageLevel.Warning:
	                iconName = 'icon-warning';
	                break;
	            case MessageBox_Props_1.MessageLevel.Error:
	                iconName = 'icon-error';
	                break;
	        }
	        return React.createElement(Dialog_1.Dialog, { title: title, isOpen: isOpen, onDismiss: onDismiss, hasCloseXButton: hasCloseXButton, containerClassName: "message-box-dialog" }, React.createElement("div", { className: "message-box-container" }, React.createElement(Icon_1.Icon, { iconName: iconName }), message), isLoading && React.createElement(Spinner_1.Spinner, { className: "message-box-spinner" }), errorMessage !== undefined && errorMessage !== '' && React.createElement(Tooltip_1.Tooltip, { className: "tooltip-error", containerClass: "operation-error-tooltip-container", content: errorMessage, directionalHint: DirectionalHint_1.DirectionalHint.rightCenter }, React.createElement(Icon_1.Icon, { className: "operation-error", iconName: "icon-usklicnik" })), React.createElement(DialogFooter_1.DialogFooter, null, onClose && React.createElement(Button_1.Button, { className: "button-textual", onClick: onClose }, closeText), buttons && mappedButtons, onAccept && React.createElement(Button_1.Button, { className: "button-primary", onClick: onAccept }, acceptText)));
	    };
	    MessageBox.defaultProps = {
	        level: MessageBox_Props_1.MessageLevel.Information,
	        closeText: 'Close',
	        acceptText: 'Save',
	        isLoading: false
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(328);
	var classNames = __webpack_require__(497);
	var Spinner_Props_1 = __webpack_require__(1086);
	...
	var Spinner = /** @class */function (_super) {
	    ...
	    Spinner.prototype.render = function () {
	        var _a = this.props,
	            ...
	            label = _a.label,
	            className = _a.className;
	        return React.createElement("div", { className: classNames('spinner', className) }, React.createElement("div", { className: classNames('spinner-circle', { 'spinner-small': type === Spinner_Props_1.SpinnerType.small }, { 'spinner-normal': type === Spinner_Props_1.SpinnerType.normal }, { 'spinner-large': type === Spinner_Props_1.SpinnerType.large }) }), label && React.createElement("div", { className: classNames('spinner-label', { 'spinner-size-small': type === Spinner_Props_1.SpinnerType.small }, { 'spinner-size-normal': type === Spinner_Props_1.SpinnerType.normal }, { 'spinner-size-large': type === Spinner_Props_1.SpinnerType.large }) }, label));
	    };
...
/***/ function(module, exports) {
	...
	(function (SpinnerType) {
	    SpinnerType[SpinnerType["small"] = 0] = "small";
	    SpinnerType[SpinnerType["normal"] = 1] = "normal";
	    SpinnerType[SpinnerType["large"] = 2] = "large";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./Spinner.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./Spinner.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n@keyframes spinner-spin {\n  0% {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n  100% {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n\n.spinner {\n  text-align: center;\n}\n\n.spinner .spinner-circle {\n  margin: 0 auto;\n  border-top: 1.4em solid #DADADB;\n  border-right: 1.4em solid #DADADB;\n  border-bottom: 1.4em solid #DADADB;\n  border-left: 1.4em solid #F79428;\n  -webkit-transform: translateZ(0);\n  -ms-transform: translateZ(0);\n  transform: translateZ(0);\n  -webkit-animation: spinner-spin 1.1s infinite linear;\n  animation: spinner-spin 1.1s infinite linear;\n  font-size: 10px;\n  border-radius: 50%;\n}\n\n.spinner .spinner-circle.spinner-small {\n  width: 10px;\n  font-size: 3px;\n  height: 10px;\n}\n\n.spinner .spinner-circle.spinner-normal {\n  width: 25px;\n  font-size: 5px;\n  height: 25px;\n}\n\n.spinner .spinner-circle.spinner-large {\n  width: 65px;\n  height: 65px;\n}\n\n.spinner .spinner-label {\n  margin-top: 10px;\n}\n\n.spinner .spinner-label.spinner-size-normal {\n  font-size: 12px;\n}\n\n.spinner .spinner-label.spinner-size-small {\n  font-size: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./messageBox.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./messageBox.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .message-box-container {\n  max-width: 600px;\n  font-size: 16px;\n  display: flex;\n  align-items: center;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .message-box-container .icon {\n  font-size: 24px;\n  margin-right: 10px;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .message-box-container .icon.icon-details {\n  color: #25A7EF;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .message-box-container .icon.icon-error {\n  color: #FB6464;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .message-box-container .icon.icon-warning {\n  color: #EAC71A;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .spinner {\n  position: absolute;\n  padding: 0 0 20px 14px;\n  bottom: 0;\n  left: 0;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .operation-error-tooltip-container {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  margin: 0 0 23px 22px;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .operation-error-tooltip-container:hover {\n  cursor: pointer;\n}\n\n.message-box-dialog > .dialog-inner .dialog-content .operation-error-tooltip-container .icon {\n  font-size: 20px;\n  color: #FB6464;\n}\n\n.message-box-dialog > .dialog-inner .dialog-actions {\n  padding-left: 50px;\n}\n", ""]);
...
//# sourceMappingURL=MessageBox.b3d14060d786be20b6e9.js.map