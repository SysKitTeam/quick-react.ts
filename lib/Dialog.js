...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog_1 = __webpack_require__(1058);
	var DialogFooter_1 = __webpack_require__(1059);
	var TextField_1 = __webpack_require__(1066);
	var Index = /** @class */function (_super) {
	    __extends(Index, _super);
	    function Index() {
	        var _this = _super.call(this) || this;
	        _this.state = { showDialog: false, showDialog2: false, showDialog3: false };
	        return _this;
	    }
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(Button_1.Button, { onClick: this._toggleDialog.bind(this) }, "Open Dialog"), " ", React.createElement("br", null), React.createElement("br", null), React.createElement(Button_1.Button, { onClick: this._toggleDialog2.bind(this) }, "Open Dialog2"), " ", React.createElement("br", null), React.createElement("br", null), React.createElement(Dialog_1.Dialog, { isOpen: this.state.showDialog, onDismiss: this._toggleDialog.bind(this) }, React.createElement("div", { style: { width: '500px' } }, React.createElement(TextField_1.TextField, { label: "TextField with a placeholder:", placeholder: "Now I am a Placeholder" }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Required TextField:", required: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Disabled TextField:", disabled: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Error TextField:", errorMessage: 'Error Message' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Description TextField:", description: 'Description Message' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: 'Underlined TextField:', placeholder: "Underlined TextField", underlined: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Multiline TextField:", multiline: true, rows: 4, cols: 50 }), React.createElement(TextField_1.TextField, { label: "TextField with a placeholder:", placeholder: "Now I am a Placeholder" }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Required TextField:", required: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Disabled TextField:", disabled: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Error TextField:", errorMessage: 'Error Message' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Description TextField:", description: 'Description Message' }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: 'Underlined TextField:', placeholder: "Underlined TextField", underlined: true }), " ", React.createElement("br", null), React.createElement(TextField_1.TextField, { label: "Multiline TextField:", multiline: true, rows: 4, cols: 50 })), React.createElement(DialogFooter_1.DialogFooter, null, React.createElement(Button_1.Button, { className: 'button-textual', onClick: this._toggleDialog.bind(this) }, "Cancel"), React.createElement(Button_1.Button, { className: 'button-primary-gray', onClick: this._toggleDialog.bind(this) }, "Discard"), React.createElement(Button_1.Button, { className: 'button-primary', onClick: this._toggleDialog.bind(this) }, "Save"))), React.createElement(Dialog_1.Dialog, { isOpen: this.state.showDialog2, onDismiss: this._toggleDialog2.bind(this), title: 'Warning', subText: 'This is warning message and you have to fix it!' }, React.createElement(DialogFooter_1.DialogFooter, null, React.createElement(Button_1.Button, { className: 'button-textual', onClick: this._toggleDialog2.bind(this) }, "Cancel"), React.createElement(Button_1.Button, { className: 'button-primary', onClick: this._toggleDialog2.bind(this) }, "Save"))));
	    };
	    Index.prototype._toggleDialog = function () {
	        this.setState({ showDialog: !this.state.showDialog });
	    };
	    Index.prototype._toggleDialog2 = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Common_1 = __webpack_require__(536);
	var getId_1 = __webpack_require__(551);
	var Layer_1 = __webpack_require__(542);
	var Popup_1 = __webpack_require__(1062);
	var Overlay_1 = __webpack_require__(1063);
	var Icon_1 = __webpack_require__(518);
	...
	var Dialog = /** @class */function (_super) {
	    ...
	    Dialog.prototype.render = function () {
	        var _a = this.props,
	            ...
	            useOpenCloseAnimation = _a.useOpenCloseAnimation;
	        ...
	        var dialogMainClass = classNames('dialog-main', this.props.contentClassName, this.state.dialogClass);
	        var groupings = this._groupChildren();
	        if (subText) {
	            subTextContent = React.createElement("span", { className: 'dialog-subText', id: id + '-subText' }, subText);
	        }
	        return React.createElement(Layer_1.Layer, { onLayerMounted: onLayerMounted || onLayerDidMount, className: classNames(layerClassName, 'dropdown-projected-layer') }, React.createElement(Popup_1.Popup, { role: "dialog", onDismiss: onDismiss, style: { height: '100%' } }, React.createElement("div", { className: dialogClassName, ref: this._onDialogRef }, React.createElement(Overlay_1.Overlay, { isDarkThemed: isDarkOverlay, onClick: isBlocking ? null : onDismiss }), React.createElement("div", { className: dialogMainClass, ref: this._getContainerRef, tabIndex: 0, onKeyUp: this._onContainerKeyUp }, React.createElement("div", { className: 'dialog-header' }, React.createElement("div", { className: 'dialog-title', id: id + '-title' }, title), React.createElement("div", { className: 'dialog-topButton' }, hasCloseXButton && React.createElement(Icon_1.Icon, { disabled: false, className: 'dialog-button dialog-button-close', onClick: onDismiss, iconName: 'icon-delete' }))), React.createElement("div", { className: 'dialog-inner' }, React.createElement("div", { className: classNames('dialog-content', this.props.contentClassName) }, icon && React.createElement(Icon_1.Icon, { className: 'dialog-icon', iconName: icon }), subTextContent, groupings.contents), groupings.footers)))));
	    };
	    Dialog.prototype._getContainerRef = function (ref) {
	        this._containerRef = ref;
	        this._checkDialogHeight(ref);
	    };
	    Dialog.prototype._checkDialogHeight = function (ref) {
	        if (ref) {
	            if (Math.abs(window.innerHeight - ref.clientHeight) <= this.windowPadding) {
	                this.setState(__assign({}, this.state, { dialogClass: 'dialog-container' }));
	            }
	        }
	    };
	    Dialog.prototype._onContainerKeyUp = function (ev) {
	        switch (ev.which) {
	            case KeyCodes_1.KeyCodes.escape:
	                if (this.props.onDismiss) {
	                    this.props.onDismiss();
	    ...
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [HTMLDivElement]), __metadata("design:returntype", void 0)], Dialog.prototype, "_getContainerRef", null);
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], Dialog.prototype, "_onContainerKeyUp", null);
	    return Dialog;
	}(Common_1.CommonComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n@keyframes fadeIn {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n\n@keyframes fadeOut {\n  from {\n    opacity: 1;\n  }\n  to {\n    opacity: 0;\n  }\n}\n\n.dialog.is-open {\n  display: block;\n  line-height: 100vh;\n  text-align: center;\n  height: 100%;\n}\n\n.dialog.is-animatingOpen {\n  animation-name: fadeIn;\n  animation-duration: 700ms;\n  -webkit-animation-duration: 700ms;\n}\n\n.dialog.is-animatingClose {\n  animation-name: fadeOut;\n  animation-duration: 700ms;\n  -webkit-animation-duration: 700ms;\n}\n\n.dialog .dialog-main {\n  vertical-align: middle;\n  display: inline-block;\n  border-radius: 8px;\n  box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.4);\n  background-color: #ffffff;\n  box-sizing: border-box;\n  line-height: 1.35;\n  position: relative;\n  text-align: left;\n  max-width: calc(100% - 70px);\n  max-height: calc(100% - 70px);\n}\n\n.dialog .dialog-main.dialog-container {\n  height: 100%;\n}\n\n.dialog .dialog-main:focus {\n  outline: none;\n}\n\n.dialog .dialog-main .dialog-header {\n  box-sizing: border-box;\n  background-color: #F79428;\n  border-radius: 8px 8px 0 0;\n}\n\n.dialog .dialog-main .dialog-header .dialog-title {\n  margin: 0;\n  font-size: 18px;\n  font-weight: 100;\n  padding: 13px 20px;\n  color: #ffffff;\n  user-select: none;\n  height: 24px;\n}\n\n.dialog .dialog-main .dialog-header .dialog-topButton {\n  position: absolute;\n  top: 0;\n  right: 0;\n  padding: 14px 12px 0 0;\n}\n\n.dialog .dialog-main .dialog-header .dialog-topButton .dialog-button-close {\n  cursor: pointer;\n  color: #ffffff;\n  font-size: 16px;\n}\n\n.dialog .dialog-main .dialog-inner {\n  padding: 0 0 20px 20px;\n  height: calc(100% - 70px);\n  position: relative;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-content {\n  display: flex;\n  max-height: calc(100% - 82px);\n  overflow-y: auto;\n  height: 100%;\n  padding-right: 20px;\n  padding-top: 20px;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-content .dialog-subText {\n  line-height: 1.5;\n  display: inline-flex;\n  align-items: center;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-content .dialog-icon {\n  font-size: 28px;\n  margin-right: 10px;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-actions {\n  margin-top: 30px;\n  padding-right: 20px;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-actions .dialog-actionsRight {\n  text-align: right;\n}\n\n.dialog .dialog-main .dialog-inner .dialog-actions .dialog-actionsRight .dialog-action + .dialog-action {\n  margin-left: 15px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var autobind_1 = __webpack_require__(546);
	var KeyCodes_1 = __webpack_require__(535);
	var Async_1 = __webpack_require__(1067);
	var getId_1 = __webpack_require__(551);
	...
	var TextField = /** @class */function (_super) {
	    ...
	    function TextField(props) {
	        var _this = _super.call(this, props) || this;
	        _this._id = getId_1.getId('textField');
	        _this._descriptionId = getId_1.getId('textFieldDescription');
	        _this._async = new Async_1.Async(_this);
	        _this.state = {
	    ...
	    TextField.prototype.render = function () {
	        ...
	        return React.createElement("div", { className: textFieldClassName, id: this.props.id }, label && React.createElement(Label_1.Label, { htmlFor: this._id }, label), iconClass && React.createElement("i", { className: iconClass }), multiline ? this._renderTextArea() : this._renderInput(), description && React.createElement("span", { id: this._descriptionId }, React.createElement("span", { className: 'textField-description' }, description)));
	    };
	    /**
	    ...
	    */
	    ...
	    TextField.prototype._renderTextArea = function () {
	        ...
	        if (!this.props.errorMessage) {
	            return React.createElement("textarea", __assign({}, textAreaProps, { id: this._id, ref: function (c) {
	                ...
	                }, value: this.state.value, onChange: this._onInputChange, onKeyUp: this._onKeyUp, className: this._fieldClassName, onFocus: this._onFocus, onBlur: this._onBlur }));
	        }
	        return React.createElement(Tooltip_1.Tooltip, { content: this.props.errorMessage, className: "tooltip-error", showTooltip: this.state.isFocused, directionalHint: DirectionalHint_1.DirectionalHint.bottomLeftEdge }, React.createElement("div", { className: "text-field-textarea-error-content" }, React.createElement("textarea", __assign({}, textAreaProps, { id: this._id, ref: function (c) {
	                return _this._field = c;
	            }, value: this.state.value, onChange: this._onInputChange, onKeyUp: this._onKeyUp, className: this._fieldClassName, onFocus: this._onFocus, onBlur: this._onBlur }))));
	    };
	    TextField.prototype._renderInput = function () {
	        ...
	        return React.createElement(Tooltip_1.Tooltip, { content: this.props.errorMessage, className: "tooltip-error", showTooltip: this.state.isFocused, directionalHint: DirectionalHint_1.DirectionalHint.bottomLeftEdge }, React.createElement("div", { className: "text-field-input-error-content" }, React.createElement("input", __assign({ type: 'text' }, inputProps, { id: this._id, ref: function (c) {
	                return _this._field = c;
	            }, value: this.state.value, onChange: this._onInputChange, onKeyUp: this._onKeyUp, className: this._fieldClassName, onFocus: this._onFocus, onBlur: this._onBlur })), React.createElement("div", { className: "textField-error-icon" }, React.createElement(Icon_1.Icon, { iconName: 'icon-usklicnik' }))));
	    };
	    ...
	    __decorate([autobind_1.autobind, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], TextField.prototype, "_onKeyUp", null);
	    return TextField;
	}(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n* {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  color: #4D4D4F;\n}\n\n::-webkit-scrollbar {\n  width: 8px;\n  height: 8px;\n}\n\n/* Track */\n::-webkit-scrollbar-track {\n  border-radius: 10px;\n  background: #DADADB;\n  border: 2px solid transparent;\n  background-clip: content-box;\n}\n\n/* Handle */\n::-webkit-scrollbar-thumb {\n  border-radius: 10px;\n  background: #AEAEAF;\n}\n\n::-webkit-scrollbar-thumb:hover {\n  background: #4D4D4F;\n}\n\n.ReactVirtualized__Grid:focus, .ReactVirtualized__Collection:focus {\n  outline: none !important;\n}\n\n.label {\n  box-sizing: border-box;\n  display: block;\n  padding: 5px 0;\n}\n\n.label.label-required::after {\n  content: ' *';\n  color: #FB6464;\n}\n\n.label.label-disabled {\n  color: #AEAEAF;\n}\n\n.text-field {\n  margin-bottom: 8px;\n}\n\n.text-field .label {\n  padding: 2px 0;\n}\n\n.text-field .textField-field {\n  box-sizing: border-box;\n  border: 1px solid #DADADB;\n  border-radius: 8px;\n  padding: 5px 10px 6px 10px;\n  width: 100%;\n  outline: 0;\n}\n\n.text-field .textField-field:hover {\n  border-color: #B7B7B8;\n}\n\n.text-field .textField-field:active, .text-field .textField-field:focus {\n  border-color: #F79428;\n}\n\n.text-field .textField-field[disabled] {\n  background-color: #F3F3F4;\n  border-color: #DADADB;\n  color: #AEAEAF;\n  pointer-events: none;\n  cursor: default;\n}\n\n.text-field .textField-field.textField-field-unresizable {\n  resize: none;\n}\n\n.text-field .textField-field.textField-invalid {\n  border-color: #FB6464;\n}\n\n.text-field .textField-field.textField-invalid:hover {\n  border-color: #FB6464;\n}\n\n.text-field .textField-error-icon {\n  position: relative;\n  top: -25px;\n  float: right;\n}\n\n.text-field .textField-error-icon .icon {\n  font-size: 12px;\n  color: #FB6464;\n}\n\n.text-field .textField-description {\n  font-size: 12px;\n}\n\n.text-field.text-field-multiline .textField-field {\n  min-height: 32px;\n  min-width: 200px;\n}\n\n.text-field.text-field-underlined {\n  width: 100%;\n}\n\n.text-field.text-field-underlined:active, .text-field.text-field-underlined:focus {\n  border-color: #F79428;\n}\n\n.text-field.text-field-underlined .textField-field {\n  border: 0;\n  border-bottom: 1px solid #DADADB;\n  border-radius: 0;\n}\n\n.text-field.text-field-underlined .textField-field:hover {\n  border-color: #B7B7B8;\n}\n\n.text-field.text-field-underlined .textField-field:active, .text-field.text-field-underlined .textField-field:focus {\n  border-color: #F79428;\n}\n\n.text-field.text-field-underlined .textField-field.textField-invalid {\n  border-color: #FB6464;\n}\n\n.text-field.text-field-underlined .textField-field.textField-invalid:hover {\n  border-color: #FB6464;\n}\n\n.text-field.text-field-underlined.is-disabled {\n  border-bottom-color: #DADADB;\n}\n\n.text-field.text-field-underlined.is-disabled .label {\n  color: #AEAEAF;\n}\n\n.text-field.text-field-underlined.is-active {\n  border-color: #F79428;\n}\n\n.text-field.is-disabled .label {\n  color: #AEAEAF;\n}\n\n.text-field.is-required .label:after {\n  content: ' *';\n  color: #FB6464;\n}\n", ""]);
...
//# sourceMappingURL=Dialog.b3d14060d786be20b6e9.js.map