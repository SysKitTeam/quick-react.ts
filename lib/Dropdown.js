...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = /** @class */function (_super) {
	    ...
	    Index.prototype.render = function () {
	        return React.createElement("div", null, React.createElement(Dropdown_1.Dropdown, { hasTitleBorder: true, dropdownType: Dropdown_Props_1.DropdownType.selectionDropdown, label: "Dropdown:", onClick: function (option, index) {
	                return console.log(option, index);
	            }, showArrowIcon: false, options: [{ key: 'A', text: 'Option a' }, { key: 'B', text: 'Option b' }, { key: 'C', text: 'Option c' }, { key: 'D', text: 'Option d' }, { key: 'E', text: 'Option e' }, { key: 'F', text: 'Option f' }, { key: 'G', text: 'Option g' }, { key: 'H', text: 'Option h', selected: true }, { key: 'I', text: 'Option i' }, { key: 'J', text: 'Option j' }] }), React.createElement(Dropdown_1.Dropdown, { hasTitleBorder: true, dropdownType: Dropdown_Props_1.DropdownType.selectionDropdown, label: "Dropdown:", onClick: function (option, index) {
	                return console.log(option, index);
	            }, options: [{ key: 'A', text: 'Option a', icon: 'icon-add' }, { key: 'B', text: 'Option b', icon: 'icon-buy' }, { key: 'C', text: 'Option c', icon: 'icon-user' }, { key: 'D', text: 'Option d' }, { key: 'E', text: 'Option e' }, { key: 'F', text: 'Option f' }, { key: 'G', text: 'Option g' }, { key: 'H', text: 'Option h', selected: true }, { key: 'I', text: 'Option i' }, { key: 'J', text: 'Option j' }] }), React.createElement(Dropdown_1.Dropdown, { hasTitleBorder: true, dropdownType: Dropdown_Props_1.DropdownType.selectionDropdown, label: "Disabled Dropdown:", disabled: true, onClick: function (option, index) {
	                return console.log(option, index);
	            }, options: [{ key: 'A', text: 'Option a', icon: 'icon-add' }, { key: 'B', text: 'Option b', icon: 'icon-buy' }, { key: 'C', text: 'Option c', icon: 'icon-user' }, { key: 'D', text: 'Option d' }, { key: 'E', text: 'Option e' }, { key: 'F', text: 'Option f' }, { key: 'G', text: 'Option g' }, { key: 'H', text: 'Option h', selected: true }, { key: 'I', text: 'Option i' }, { key: 'J', text: 'Option j' }] }), React.createElement(Dropdown_1.Dropdown, { icon: 'icon-add', label: "Icon Dropdown:", className: 'icon-dropdown', dropdownType: Dropdown_Props_1.DropdownType.customDropdown }, React.createElement(Label_1.Label, { style: { paddingLeft: '5px' } }, "Header"), React.createElement("hr", null), React.createElement("li", { style: { display: 'inline-block', padding: '5px', width: '100px' } }, React.createElement(Icon_1.Icon, { style: { paddingTop: '5px' }, iconName: 'icon-account' }), React.createElement(Slider_1.Slider, { min: 0, max: 50, step: 5, defaultValue: 20 })), React.createElement("li", { style: { display: 'inline-block', padding: '5px', width: '100px' } }, React.createElement(Icon_1.Icon, { style: { paddingTop: '5px' }, iconName: 'icon-account' }), React.createElement(Slider_1.Slider, { min: 0, max: 50, step: 5, defaultValue: 20 }))), React.createElement("div", null, React.createElement(Label_1.Label, null, "Button + Arrow Dropdown:"), React.createElement("div", { style: { display: 'inline-flex' } }, React.createElement(Button_1.Button, { className: 'button-primary', icon: 'icon-add', style: { borderRadius: '8px 0 0 8px' } }), React.createElement(Dropdown_1.Dropdown, { className: 'arrow-dropdown', dropdownType: Dropdown_Props_1.DropdownType.customDropdown }, React.createElement("li", { className: 'dropdown-item' }, "Option a"), React.createElement("li", { className: 'dropdown-item is-selected' }, "Option b"), React.createElement("li", { className: 'dropdown-item' }, "Option c"), React.createElement("li", { className: 'dropdown-item' }, "Option d")))));
	    };
	    return Index;
	}(React.Component);
	exports.Index = Index;
...
//# sourceMappingURL=Dropdown.b3d14060d786be20b6e9.js.map