...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddToFavorites_1 = __webpack_require__(487);
	var Index = function (_super) {
	    ...
	    Index.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", null, React.createElement(AddToFavorites_1.AddToFavorites, { favorited: this.state.favorited }), React.createElement("br", null), React.createElement(Button_1.Button, { onClick: function () {
	                _this.setState({ favorited: !_this.state.favorited });
	            } }, "Toggle Favorite"));
	    };
	    ;
	    return Index;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./AddToFavorites.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js?outputStyle=expanded!./AddToFavorites.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
//# sourceMappingURL=AddToFavorites.5af099dfabf0e722b9fa.js.map