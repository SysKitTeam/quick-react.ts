...
export const peoplePickerData: IPrincipal[] = [
    { identifier: '1', displayName: 'FirstName1 LastName1 loooong loooong looooong', email: 'username1@domain1', type: 1 },
    { identifier: '2', displayName: 'FirstName2 LastName2', email: 'username2@domain2', type: 2 },
