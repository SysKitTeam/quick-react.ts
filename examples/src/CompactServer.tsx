    ...
    public render() {
        return (
            <div>
                ...
                <CompactServer id={'My very very long name of a server I am using I know its very long.domain.com' } onClose={this._onServerCloseCompactServer} onRoleEdit={this._onClickCompactServer} name={'My very very long name of a server I am using I know its very long'} roles={[]} status={2} />
                <CompactServer id={'BANANA-PC.banana.com' } onClose={this._onServerCloseCompactServer} onRoleEdit={this._onClickCompactServer} name={'BANANA-PC'} roles={[{ display: 'WPF', iconName: 'icon-add' }, { display: 'Search', iconName: 'icon-alert' }]} status={0} />
            </div>
        );
    }
