    ...
    public render() {
        return (
            <div>
                ...
                <Dashboard groupOnClick={function(farmId){ console.log("You clicked on group:" + farmId); }} farms={this.state.farms} filter={''} title={this.state.farms.title} activeView={0}  hasAddFarmButton={true} addFarm={() => console.log('specify action!')}/>
