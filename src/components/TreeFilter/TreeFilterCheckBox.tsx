...
export class TreeFilterCheckBox extends React.PureComponent<ITreeFilterCheckBoxProps, any> {
    render() {
        ...
        return (
            <div
                className={classNames('TreeFilter-checkbox', { 'icon-partial-selected': checked === CheckStatus.ChildChecked })}
                onClick={onChange} >
                <input
                    {...isChecked}
                ...
                />
                {isChecked &&
                    <Icon className={'TreeFilter-checkbox-checkmark'} iconName={'icon-checkmark'} />
                }
