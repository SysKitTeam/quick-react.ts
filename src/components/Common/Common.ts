...
export class CommonComponent<P, S> extends React.Component<P, S> {
    ...
    constructor(props?: P, deprecatedProps?: { [propName: string]: string }) {
        ...
        _makeAllSafe(this, CommonComponent.prototype, [
            'componentWillMount',
            'componentDidMount',
 ...
 */
function _makeAllSafe(obj: CommonComponent<any, any>, prototype: Object, methodNames: string[]) {
    for (let i = 0, len = methodNames.length; i < len; i++) {
        _makeSafe(obj, prototype, methodNames[i]);
    }
}

function _makeSafe(obj: CommonComponent<any, any>, prototype: Object, methodName: string) {
    ...
    if (classMethod || prototypeMethod) {
        obj[methodName] = function () {
            ...
            try {
                ...
                if (CommonComponent.onError) {
                    CommonComponent.onError(errorMessage, e);
                }
            }
...
function _warnDeprecation(obj: CommonComponent<any, any>, propertyName: string, newPropertyName: string) {
...
CommonComponent.onError = (errorMessage) => {
